 ...
 * </pre>
 */
public class FecCandidateContributionRecord extends DataRecord {
  ...
  public static enum Fields { CMTE_ID, AMNDT_IND, RPT_TP, TRANSACTION_PGI, IMAGE_NUM, TRANSACTION_TP, ENTITY_TP, NAME, CITY, STATE, ZIP_CODE, EMPLOYER, OCCUPATION, 
    TRANSACTION_DT, TRANSACTION_AMT, OTHER_ID, CAND_ID, TRAN_ID, FILE_NUM, MEMO_CD, MEMO_TEXT, SUB_ID }
  ...
  private static FecCandidateContributionRecord unsafeRecord = new FecCandidateContributionRecord();
  public static FecCandidateContributionRecord parse(String rowData) {
    unsafeRecord.update(rowData);
    return unsafeRecord;
  }

  private FecCandidateContributionRecord() {
  }
