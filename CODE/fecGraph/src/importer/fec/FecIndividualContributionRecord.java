 ...
 * </pre>
 */
public class FecIndividualContributionRecord extends DataRecord {
  ...
  private static FecIndividualContributionRecord unsafeRecord = new FecIndividualContributionRecord();
  public static FecIndividualContributionRecord parse(String rowData) {
    unsafeRecord.update(rowData);
    return unsafeRecord;
  }

  private FecIndividualContributionRecord() {
  }
  ...
  public String otherID() { return (String)getField(Fields.OTHER_ID.name()); }
