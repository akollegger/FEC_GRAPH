...
public class RawFecImporter implements FecBatchImporter {
    ...
    enum FecRelationshipTypes implements RelationshipType {LINKS, SUPPORTS, FOR, CONTRIBUTES, RECEIVES, GAVE,SUPERPACGIFT,SUPERPACEXPEND,SUPERPACACTION}
